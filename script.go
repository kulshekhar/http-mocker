...
func scriptInterceptorTs() (*asset, error) {
	...
	info := bindataFileInfo{name: "script/interceptor.ts", size: 3105, mode: os.FileMode(420), modTime: time.Unix(1479347513, 0)}
...
func scriptScriptMinJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "script/script.min.js", size: 2001, mode: os.FileMode(420), modTime: time.Unix(1479347514, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
